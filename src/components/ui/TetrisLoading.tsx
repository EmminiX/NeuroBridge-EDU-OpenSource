    ...
    <div className="flex flex-col items-center justify-center">
      ...
      {showLoadingText && (
        <div className="text-center mt-2">
          <p className="font-bold text-xl relative inline-flex items-center gap-1">
            <span 
              className="inline-block"
              style={{
                background: 'linear-gradient(90deg, #1e40af, #9333ea, #dc2626, #9333ea, #1e40af)',
            ...
            {loadingText.includes('...') && (
              <span className="inline-flex items-center gap-0.5 ml-1">
                <span 
                  className="inline-block text-2xl font-black text-blue-600"
                  style={{ 
                ...
                <span 
                  className="inline-block text-2xl font-black text-purple-600"
                  style={{ 
                    filter: 'drop-shadow(0 0 3px rgba(147, 51, 234, 0.6))',
                  }}
                >
                  •
                </span>
                <span 
                  className="inline-block text-2xl font-black text-red-600"
                  style={{ 
